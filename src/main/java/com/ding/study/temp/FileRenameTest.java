...
public class FileRenameTest {
    ...
    static String oldString = "生活大爆炸.The.Big.Bang.Theory.2015.S09E";//要被替换的字符串
    static String dir = "F:\\下载\\连续剧\\生活大爆炸全";//文件所在路径，所有文件的根目录，记得修改为你电脑上的文件所在路径
//将小括号()替换为~;
//String str2 = str.replaceAll("[( )]", "~");

  //替换[]  newName = fileName.replaceAll("\\[", "").replaceAll("\\]", "");//新名字
        ...
        if (folder.exists()) {
            ...
            if (null == fileArr || fileArr.length == 0) {
                ...
                for (File file : fileArr) {
                  ...
                  //      newName = fileName.replaceAll("\\[", "").replaceAll("\\]", "");//新名字

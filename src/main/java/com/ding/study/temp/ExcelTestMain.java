          ...
          //  System.out.println(""+JsonUtils.convertObjToJsonString(jun));
           // System.out.println(" update xx set status=8 ,hold_days='" + getStringZhengShu(jun.getData7().replaceAll(" ", "")) + "' ,total_profit='" + jun.getData6() + "'  where  investment_org_id='" + replace(jun.getData2()) + "' ; ");
            ...
            String sql="\n" +
                    ...
                    "('"+getStringDelZero(jun.getData1())+"','"+getStringDelZero(jun.getData2())+"','"+jun.getData3()+"','"+jun.getData9()+"','2023-12-31 00:00:00','"+ jun.getData4()+"','"+jun.getData5()+"',\n" +
                    "'ZMA"+getStringDelZero(jun.getData1())+"_"+getStringDelZero(jun.getData2())+"','202312','2023-12',0);";

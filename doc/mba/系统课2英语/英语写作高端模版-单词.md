...
It is shown in the chart that remarkable changed occurred in terms of 主题 from 2011 to 2019.
In light of the information provided has the percentage of A underwent a rapid decline,
go down from approximately 5% in 2011 to 87% in 2019.In the meantime ,the percentage of B changed from 66 to 21.

In my view ,this phenomenon attributable a great number of factor, 
among which three primary one ares
  as follow.
  First of all , economic development has,to some extent ,led to these changes.
 Unlike to counterpart in the old days ,people currently enjoy better living standard and therefore afford phone.
 Secondly ,government support serves as driving force this phenomenon.
 In fact , a number of effective policies have been implements of promote to development phone industry.
 finally, development science and technology also play a role  in the respect .
 Thank new technology , people now enjoy a more convenient life.
 Base on discuss above ,we may have safely draw conclusion that reason contribution this phenomenon are complex.
 I firmly believe it will a continue  gather momentum in the coming years.

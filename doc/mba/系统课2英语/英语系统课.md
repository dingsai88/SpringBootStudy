...
有时在句中并不指其身份和职业，而是含有较强的动作意味，在汉语中没
有恰当的对应名词时，往往可以译成动词。

I am afraid I can't teach you swimming. I think my little brother is a
...
英语中表示知觉、情欲、欲望等心理状态的形容词，在系动词后作表语用时，往往
可转译成动词。如 confident, certain, careful, cautious, angry, sure, ignorant, afraid,
doubtful, aware, concerned, glad, delighted, sorry, ashamed, thankful, anxious…etc.
...
1.英语中很多由名词派生的动词，以及由名词转用的动词，在汉语中往
...
2.有些英语被动式句子中的动词，可以译成"受（遭）到……+名词"、"予（加）
  以+名词"这类结构。
  Satellites, however, must be closely watched, for they are constantly being
...
常见：the + 某些形容词=表示一类人或物两个彼此意义对立的形容词连用时



The young and the old converge on one key point.


The president was adored by rich and poor alike.



此外，根据情况还有些形容词可以译成名词。
Steven was eloquent and elegant——but soft. 
...
2.名词转译成副词
The new mayor earned some appreciation by the courtesy of coming to
visit the city poor. 
...
We found difficulty in solving this problem
...
1. 英语动词译成汉语名词时，修饰该动词的副词往往转译成汉语形容词。
...
participants in each group made the wrong choice two or more times.
...
These are the basic questions of the philosophy of language. And here’s a
natural-seeming way of answering them.


Pollution is the price we pay for an overpopulated，over-industrialized
planet. When we come to think about it, there are only four ways you can deal
with rubbish: dump it, burn it, turn it into something you can use again,
attempt to produce less of it.



**省略代词**
Complicated as seems the problem，it can be solved in only ten minutes with a computer.



感叹句：what +（a/an）+adj.+n.+主语+谓语
...
We are all born into this world as equals，but for various
reasons，not all of us are treated as equals. This inequality begins
when we reach the age of five, for that is when we will enter
elementary school. In school, we are no longer “Mommy’s darlings”.
We now have to prove ourselves to the other children and also to our
teacher. If we seem different from the other children, we are treated
differently. These differences could be anything: pants, shoes, speech,
religion, and so forth. It really doesn’t matter. Yet right from the start,
we think that as long as we are different , there is something wrong
with us.


我们生到这个世界上都是公平的，但是因为各种原因，并不是
所有的人都受到公平的待遇。这种不公从我们五岁就开始了，因为
从那时起我们就开始上小学了。在学校里，孩子已不再是妈妈的心
肝宝贝儿。我们现在不得不向同学和老师证明我们自己。如果我们
和别的小孩儿不同，我们就会被特殊对待。这种不同可能是任何事：
裤子、鞋、语言、宗教等。这其实没有什么大不了的，但是从一开
始，我们就会觉得既然我们不一样，那问题一定出在我们自己身上
了。




英语人称代词再使用时一般不能随意变换，而再汉语种有时
可以变换。再翻译过程中，有必要根据情况对某些人称代词进
行替代。

我们生到这个世界上都是公平的，但是因为各种原因，并不是
所有的人都受到公平的待遇。这种不公从你五岁就开始了，因为从
那时起你就开始上小学了。在学校里，孩子已不再是妈妈的心肝宝
贝儿。你现在不得不向同学和老师证明你自己。如果一个孩子和别
的孩子不同，他们就会被特殊对待。这种不同可能是任何事：裤子、
鞋、语言、宗教等。这其实没有什么大不了的，但是从一开始，你
就会觉得既然你不一样，那问题一定出在你自己身上了。
...
They said it will be a clear day tomorrow.


在英语表达中还经常使用it 作形式主语来表达泛指，主要有以下几个句型。
形式主语it 翻译时候，省略不译。
It is said that… _____________________
It is rumored that… _____________________
It is (well) known that… _____________________
It is (generally) considered that… _____________________
...
四种句子种类：简单句、并列句、主从句、并列主从句
简单句：只包含一个主谓结构，句子各个成分都只由单词或短语表示
的句子。


主+谓 The sun rises.
主+谓（系）+表 English is interesting.
主+谓+宾 I like English.
主+谓+间宾+直宾 English brings me good luck.
主+谓+宾+宾补 English makes me happy. 
